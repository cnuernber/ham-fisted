	     ...
	     IObj, IEditableCollection, ImmutValues, ArrayLists.ArrayOwner
{
  ...
  public static final ArrayImmutList9 EMPTY = new ArrayImmutList9(new Object[0], 0,0,null);

  public ArrayImmutList9(Object[] d, int sidx, int eidx, IPersistentMap meta ) {
    data = d;
    startidx = sidx;
    nElems = eidx - sidx;
    m = meta;
  }
  public static ArrayImmutList9 create(boolean owning, Object[] d,
				      int sidx, int eidx, IPersistentMap meta) {
    d = owning ? d : d.clone();
    return new ArrayImmutList9(d, sidx, eidx, meta);
  }
  ...
  final int wrapIndexCheck(int idx) {
    return startidx + Objects.checkIndex(idx < 0 ? idx + nElems : idx, nElems);
  }
